...
public class AddressController {
    ...
    public ResponseEntity<?> findById(@PathVariable Long id) {
        ...
        responseMessage.setError(Boolean.FALSE);
        responseMessage.setDate(new Date());
        responseMessage.setData(address);
        return ResponseEntity.status(HttpStatus.OK).body(responseMessage);
    }
    ...
    public ResponseEntity<?> save(@Valid @RequestBody Address address) {
         ...
         responseMessage.setError(Boolean.FALSE);
         responseMessage.setDate(new Date());
         responseMessage.setMessage("Address save with sucess");
    ...
    public ResponseEntity<?> update(@Valid @RequestBody Address address) {
        ...
        responseMessage.setError(Boolean.FALSE);
        responseMessage.setDate(new Date());
        responseMessage.setMessage("Address update with sucess");
    ...
    public ResponseEntity<?> remove(@PathVariable("id") Long id) {
        ...
        responseMessage.setError(Boolean.FALSE);
        responseMessage.setDate(new Date());
        responseMessage.setMessage("Address remove with sucess");
